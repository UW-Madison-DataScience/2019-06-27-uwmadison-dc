...
instructor: ["Trisha Adamus", "Srikanth Aravamuthan", "Heather Shimon", "Elizabeth McDaniel", "Kim O'Keefe" ] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Kaitlin Gold", "Heather James", "Tobin Magle", "Sarah Stevens"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
